...
public class HibernatePersonManagerTests {
	...
	@Test
	public void testGet() {
		Klient result = mgr.get(1);
		Klient result2 = mgr.get(1);
		Klient result3 = mgr.get(100);
	...
	public void testGetAll() {
		List<Klient> results = mgr.getAll();
	...
	public void testSave() {
		Klient p = new Klient("Tomasz","2314","Morska");
		mgr.save(p);
		Klient result = mgr.get(7);
